...
def main_menu():
    ...
    container.subheader("Chatbot Question:")
    container.write("What do you want to know about:")
    container.write("1. **Overview:** What is the Advanced Python Course about? Provide a brief summary.")
    container.write("2. **Prerequisites:** What knowledge or skills should students have before starting the course?")
    container.write("3. **Topics:** What are the main topics covered in the course? (e.g., APIs, AI in python, security & encryption, etc.)")
    container.write("4. **Projects:** What kind of projects or assignments can students expect?")
    container.write("5. **Resources:** What materials or tools will be used or recommended during the course?")
    container.write("6. **Schedule:** How long is the course and what is the typical schedule?")
    container.write("7. **Support:** How can students get help and collaborate during the course?")
    a=st.text_input("Enter your question (Number or Keyword): ")
    return a

def header():
    st.title("Advanced Python Course Chatbot")
    st.caption("Ask about the Advance Python Course details")